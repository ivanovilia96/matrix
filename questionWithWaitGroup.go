...
*/
// это то решение которое ожидалось? я книгу читал ( приостановил на изучение алгоритмов ), там как раз следующая тема была многопоточность ("язык программирования go" называется книга)
func main() {
